...
###### Office hours: [Wednesdays 4:30-5:30](https://calendar.google.com/calendar/selfsched?sstoken=UU5zeHE4U25Rc2NHfGRlZmF1bHR8OTIxZDRlNTYwNjBiNTg1Mjg4MmZjYzkwM2ZjYTBhODY) or email me
...
* Lecture: Technical concepts, explanations of example code, & reference work -- this section will be recorded and made available to everyone
* Workshop: Exercises related to the weekly topic
* Assignments: At-home practice of techniques and methods from class, based on the homework prompt or your own idea

Virtual material (class session recordings, video and text references, class notes & code) will be comprehensive and available asynchronously. Asynchronous participation will be possible through this class github, the class discussion channel, and office hours. 
